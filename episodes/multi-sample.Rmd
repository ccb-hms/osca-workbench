...
"logFC" stands for log fold-change. Rather than reporting e.g. a 5-fold increase, it usually makes more mathematical sense to report a logFC of log(5) = 1.61. 

`ENSMUSG00000037664` seems to have an estimated logFC of about -8. That's a big effect. Worth looking into whether or not it's real!
